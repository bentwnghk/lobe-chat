export default {
  ...
  guide: {
    ...
    defaultMessage:
      '我是您的私人智能助理 Mr.🆖，请问现在能帮您做什么？\n如果需要获得更加专业或定制的助手，可以点击 `+` 创建自定义助手',
    qa: {
      "q01": "Do a grammar check on the text I provide.",
      "q02": "Give me 5 different versions of the text I provide.",
      "q03": "Create a randomly generated 15-item vocabulary list from Oxford 3000, each beginning with a different letter, including their definitions in Traditional Chinese, part of speech symbols, and example sentences with Traditional Chinese translations.",
      ...
      "q07": "Teach me a random word in English.",
      "q08": "Give me a list of words and their Traditional Chinese definitions related to the theme I provide.",
      "q09": "Teach me a random topic in English grammar.",
      "q10": "Teach me a random idiom in English.",
      ...
      "q13": "Teach me how I could improve my English reading skills.",
      "q14": "Teach me how I could improve my English writing skills.",
      "q15": "Teach me how I could improve my English speaking skills."
    },
    questions: {
      moreBtn: '了解更多',
      title: '大家都在问：',
