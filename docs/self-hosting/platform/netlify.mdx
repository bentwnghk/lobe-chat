...
<Image
  alt={'Select the Mr.🆖 AI github project'}
  height={228}
  inStep
...
<Image
  alt={'Add Mr.🆖 AI site environment variables'}
  height={537}
  inStep
...
<Image
  alt={'Mr.🆖 AI deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your Mr.🆖 AI has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your Mr.🆖 AI site.
  ...
  <Image alt={'Access Your Mr.🆖 AI Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
