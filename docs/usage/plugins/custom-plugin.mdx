---
title: Custom Mr.🆖 AI Plugins Installation and Development Guide
description: >-
  Learn how to install custom plugins in Mr.🆖 AI and develop your own plugins
...
If you wish to install a plugin that is not available in the Mr.🆖 AI plugin store, such as a custom-developed Mr.🆖 AI plugin, you can click on "Custom Plugins" to install it:

<Video src="https://github.com/lobehub/lobe-chat/assets/28616219/034a328c-8465-4499-8f93-fdcdb03343cd" />

In addition, Mr.🆖 AI's plugin mechanism is compatible with ChatGPT plugins, so you can easily install corresponding ChatGPT plugins.
...
If you wish to develop a Mr.🆖 AI plugin on your own, feel free to refer to the [Plugin Development Guide](/docs/usage/plugins/development) to expand the possibilities of your AI assistant!
