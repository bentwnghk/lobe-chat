---
title: Enhance Your Mr.🆖 AI Assistant with Plugins
description: >-
  Learn how to expand your Mr.🆖 AI assistant's capabilities by enabling and
...
The plugin system is a key element in expanding the capabilities of assistants in Mr.🆖 AI. You can enhance the assistant's abilities by enabling a variety of plugins.

Watch the following video to quickly get started with using Mr.🆖 AI plugins:
...
The Plugin Store allows you to directly install and use plugins within Mr.🆖 AI.
