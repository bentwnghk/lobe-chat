---
title: 自定义插件 - Mr.🆖 AI 插件安装与开发指南
description: 学习如何安装自定义插件和开发 Mr.🆖 AI 插件，扩展你的 AI 智能助手的功能。
tags:
  - 自定义插件
  - Mr.🆖 AI
  - 插件安装
...
如果你希望安装一个不在 Mr.🆖 AI 插件商店中的插件，例如自己开发的 Mr.🆖 AI，你可以点击「自定义插件」进行安装：

<Video src="https://github.com/lobehub/lobe-chat/assets/28616219/034a328c-8465-4499-8f93-fdcdb03343cd" />

此外，Mr.🆖 AI 的插件机制兼容了 ChatGPT 的插件，因此你可以一键安装相应的 ChatGPT 插件。
...
如果你希望自行开发一个 Mr.🆖 AI 的插件，欢迎查阅 [插件开发指南](/zh/docs/usage/plugins/development) 以扩展你的 AI 智能助手的可能性边界！
