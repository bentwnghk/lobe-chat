---
title: Mr.🆖 AI Plugin Store
description: >-
  Learn how to access the Plugin Store in Mr.🆖 AI to easily install and use
...
In the plugin store, you can directly install and use plugins in Mr.🆖 AI.
