---
title: Mr.🆖 AI 会话翻译功能 - 一键实时翻译对话内容
description: Mr.🆖 AI 支持用户一键将对话内容翻译成指定语言，实时显示翻译结果。了解如何设置翻译模型以优化翻译体验。
tags:
  - Mr.🆖 AI
  - 会话翻译
  - 实时翻译
...
Mr.🆖 AI 支持用户一键将对话内容翻译成指定语言。选择目标语言后，Mr.🆖 AI 将调用预先设置的 AI 模型进行翻译，并将翻译结果实时显示在聊天窗口中。
