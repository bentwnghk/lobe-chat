---
title: Using Amazon Bedrock API Key in Mr.🆖 AI
description: >-
  Learn how to integrate Amazon Bedrock models into Mr.🆖 AI for AI-powered
...
# Using Amazon Bedrock in Mr.🆖 AI

<Image
  alt={'Using Amazon Bedrock in Mr.🆖 AI'}
  cover
...
This document will guide you on how to use Amazon Bedrock in Mr.🆖 AI:
...
<Image
  alt={'Enter Amazon Bedrock keys in Mr.🆖 AI'}
  inStep
