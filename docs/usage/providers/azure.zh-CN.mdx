---
title: 在 Mr.🆖 AI 中使用 Azure OpenAI API Key
description: 学习如何在 Mr.🆖 AI 中配置和使用 Azure OpenAI 模型进行对话，包括获取 API 密钥和选择模型。
tags:
  - Azure OpenAI
  - API Key
  - Web UI
...
# 在 Mr.🆖 AI 中使用 Azure OpenAI

<Image
  alt={'在 Mr.🆖 AI 中使用 Azure OpenAI'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13'}
/>

本文档将指导你如何在 Mr.🆖 AI 中使用 [Azure OpenAI](https://oai.azure.com/):
...
至此你已经可以在 Mr.🆖 AI 中使用 Azure OpenAI 提供的模型进行对话了。
