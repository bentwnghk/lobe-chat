---
title: Using Azure OpenAI API Key in Mr.🆖 AI
description: >-
  Learn how to integrate and configure Azure OpenAI in Mr.🆖 AI to enhance your
...
# Using Azure OpenAI in Mr.🆖 AI

<Image
  alt={'Azure OpenAI in Mr.🆖 AI'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13'}
/>

This document will guide you on how to use [Azure OpenAI](https://oai.azure.com/) in Mr.🆖 AI:
...
### Step 2: Configure Azure OpenAI in Mr.🆖 AI
...
Now you can engage in conversations using the models provided by Azure OpenAI in Mr.🆖 AI.
