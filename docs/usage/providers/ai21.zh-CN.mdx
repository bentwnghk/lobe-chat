---
title: 在 Mr.🆖 AI 中使用 AI21 Labs
description: 学习如何在 Mr.🆖 AI 中配置和使用 AI21 Labs 的API Key，以便开始对话和交互。
tags:
  - Mr.🆖 AI
  - AI21 Labs
  - API密钥
...
至此你已经可以在 Mr.🆖 AI 中使用 AI21 Labs 提供的模型进行对话了。
