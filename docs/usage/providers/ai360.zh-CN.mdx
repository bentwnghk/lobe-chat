---
title: 在 Mr.🆖 AI 中使用360智脑
description: 学习如何在 Mr.🆖 AI 中配置和使用360智脑的API Key，以便开始对话和交互。
tags:
  - Mr.🆖 AI
  - 360智脑
  - API密钥
...
至此你已经可以在 Mr.🆖 AI 中使用360智脑提供的模型进行对话了。
