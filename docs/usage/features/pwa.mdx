...
<Callout type={'tip'}>
  The default installed Mr.🆖 AI PWA icon has a black background, you can use <kbd>cmd</kbd> +  <kbd>i</kbd> to paste the following image to replace it with a white background.
</Callout>
