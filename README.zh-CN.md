...
- [👋🏻 开始使用 & 交流](#-开始使用--交流)
- [✨ 特性一览](#-特性一览)
  - [`1` \[文件上传 / 知识库\]\[docs-feat-knowledgebase\]](#1-文件上传--知识库docs-feat-knowledgebase)
  - [`2` \[多模型服务商支持\]\[docs-feat-provider\]](#2-多模型服务商支持docs-feat-provider)
  - [`3` \[支持本地大语言模型 (LLM)\]\[docs-feat-local\]](#3-支持本地大语言模型-llmdocs-feat-local)
  - [`4` \[模型视觉识别 (Model Visual)\]\[docs-feat-vision\]](#4-模型视觉识别-model-visualdocs-feat-vision)
  - [`5` \[TTS & STT 语音会话\]\[docs-feat-tts\]](#5-tts--stt-语音会话docs-feat-tts)
  - [`6` \[Text to Image 文生图\]\[docs-feat-t2i\]](#6-text-to-image-文生图docs-feat-t2i)
  - [`7` \[插件系统 (Tools Calling)\]\[docs-feat-plugin\]](#7-插件系统-tools-callingdocs-feat-plugin)
  - [`8` \[助手市场 (GPTs)\]\[docs-feat-agent\]](#8-助手市场-gptsdocs-feat-agent)
  - [`9` \[支持本地 / 远程数据库\]\[docs-feat-database\]](#9-支持本地--远程数据库docs-feat-database)
  - [`10` \[支持多用户管理\]\[docs-feat-auth\]](#10-支持多用户管理docs-feat-auth)
  - [`11` \[渐进式 Web 应用 (PWA)\]\[docs-feat-pwa\]](#11-渐进式-web-应用-pwadocs-feat-pwa)
  - [`12` \[移动设备适配\]\[docs-feat-mobile\]](#12-移动设备适配docs-feat-mobile)
  - [`13` \[自定义主题\]\[docs-feat-theme\]](#13-自定义主题docs-feat-theme)
  - [更多特性](#更多特性)
- [⚡️ 性能测试](#️-性能测试)
- [🛳 开箱即用](#-开箱即用)
...
同时，我们也在计划支持更多的模型服务商，以进一步丰富我们的服务商库。如果你希望让 Mr.🆖 AI 支持你喜爱的服务商，欢迎加入我们的 [💬 社区讨论](https://github.com/lobehub/lobe-chat/discussions/6157)。
